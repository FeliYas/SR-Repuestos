import MarcasProductoAdminRow from '@/components/marcasProductoAdminRow';
...
export default function MarcasProductoAdmin() {
    ...
    const handleSubmit = (e) => {
        ...
        post(route('admin.marcasProducto.store'), {
            preserveScroll: true,
            onSuccess: () => {
                ...
                <div className="mx-auto flex w-full flex-col gap-3">
                    ...
                    <div className="flex w-full justify-center">
                        <table className="w-full border text-left text-sm text-gray-500 rtl:text-right dark:text-gray-400">
                            ...
                            <tbody className="text-center">{marcas?.map((marca) => <MarcasProductoAdminRow key={marca.id} marca={marca} />)}</tbody>
                        </table>
                    </div>
                </div>
            </div>
