...
export default function CargaMasivaProductos() {
    const { flash } = usePage().props as {
        flash?: {
            mass_upload_summary?: MassUploadSummary;
        };
    };

    const summary = flash?.mass_upload_summary;
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        post(route('admin.cargamasiva.productos.import'), {
            preserveScroll: true,
            forceFormData: true,
            onSuccess: () => {
    ...
    return (
        <Dashboard>
            <div className="flex w-full flex-col gap-6 p-6">
                <h2 className="border-primary-orange text-primary-orange text-bold w-full border-b-2 pb-1 text-2xl">Carga masiva de productos</h2>
                ...
                <div className="rounded-md border border-gray-300 bg-white p-4">
                    ...
                    <ul className="list-disc space-y-1 pl-6 text-sm text-gray-700">
                        ...
                        <li>Columnas obligatorias: Nombre, Código, Categoría y Marca.</li>
                        <li>Columnas opcionales: Aplicación, Año, Número original, Tonelaje, Espigón, Bujes.</li>
                        <li>El orden de columnas no importa: se reconocen por nombre normalizado (trim, minúsculas y sin acentos).</li>
                        <li>Categoría y Marca deben existir previamente en la base.</li>
                ...
                <form onSubmit={handleSubmit} className="rounded-md border border-gray-300 bg-white p-4">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        ...
                        >
                            {processing ? 'Procesando...' : 'Importar productos'}
                        </button>
                    </div>
                </form>
