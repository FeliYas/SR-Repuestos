...
interface FormData {
    title: string;
    text: string;
    [key: string]: any; // Para permitir propiedades adicionales si son necesarias
}
...
export default function NosotrosAdmin() {
    ...
    const { data, setData, processing, post, reset } = useForm<FormData>({
        title: nosotrosInfo?.title || '',
        text: nosotrosInfo?.text || '',
    });
